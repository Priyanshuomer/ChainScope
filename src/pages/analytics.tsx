...
import { BarChart3, Globe, ShieldCheck, CheckCircle, Layers } from "lucide-react"
import { Card, CardContent } from "@/components/ui/card"
import { Progress } from "@/components/ui/progress"
import { useMergedChainStats } from "@/hooks/useChains" // ⬅️ hook for stats
...
const Analytics: React.FC = () => {
  ...
  {/* Page Header */}
  <div className="flex flex-col items-center mb-6"> {/* reduced from mb-10 */}
  ...
  {/* Cards Grid */}
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-4"> {/* added mb-4 to reduce bottom margin */}
    {/* Total Networks */}
