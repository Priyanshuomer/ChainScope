...
export const PRODUCTION_CONFIG = {
  ...
  API: {
    ...
    MAX_RETRIES: 2,
    MIN_CHAINS_THRESHOLD: parseInt(process.env.MIN_CHAINS_THRESHOLD || '50'),
    MIN_TVL_THRESHOLD: parseInt(process.env.MIN_TVL_THRESHOLD || '1000000'),
    TESTNET_CHAIN_ID_THRESHOLD: parseInt(process.env.TESTNET_CHAIN_ID_THRESHOLD || '1000000'),
    TRUSTED_CHAIN_IDS: process.env.TRUSTED_CHAIN_IDS || '1,10,25,56,100,137,250,324,1101,8453,42161,43114,42220'
  },

  // Chain Data Merger Configuration
  MERGER: {
    MAX_METADATA_CHAINS: parseInt(process.env.MAX_METADATA_CHAINS || '50'),
    MAX_CHAIN_ID: parseInt(process.env.MAX_CHAIN_ID || '10000'),
    POPULAR_CHAIN_IDS: process.env.POPULAR_CHAIN_IDS || '1,137,42161,10,56,43114,250,100,1101,8453',
    RPC_UPDATE_BATCH_SIZE: parseInt(process.env.RPC_UPDATE_BATCH_SIZE || '3'),
    RPC_UPDATE_DELAY_MS: parseInt(process.env.RPC_UPDATE_DELAY_MS || '1000')
  },
  ...
  UI: {
    ...
    NETWORK_COUNT: process.env.NETWORK_COUNT || '2000+',
    INITIAL_LOAD_SIZE: parseInt(process.env.INITIAL_LOAD_SIZE || '40'),
    LOAD_MORE_SIZE: parseInt(process.env.LOAD_MORE_SIZE || '20')
  },

  // Scoring System
  SCORING: {
    POPULAR_CHAIN_SCORE: parseInt(process.env.POPULAR_CHAIN_SCORE || '1000'),
    VERIFIED_CHAIN_SCORE: parseInt(process.env.VERIFIED_CHAIN_SCORE || '500'),
    RPC_MULTIPLIER: parseInt(process.env.RPC_MULTIPLIER || '10'),
    MAINNET_SCORE: parseInt(process.env.MAINNET_SCORE || '200'),
    L2_SCORE: parseInt(process.env.L2_SCORE || '100')
  },

  // RPC Configuration
  RPC: {
    OFFICIAL_RPC_SCORE_THRESHOLD: parseInt(process.env.OFFICIAL_RPC_SCORE_THRESHOLD || '100'),
    RECOMMENDED_RPC_SCORE_THRESHOLD: parseInt(process.env.RECOMMENDED_RPC_SCORE_THRESHOLD || '50'),
    TOP_RECOMMENDED_RPC_COUNT: parseInt(process.env.TOP_RECOMMENDED_RPC_COUNT || '3')
  },
  ...
  PERFORMANCE: {
    ...
    RPC_TEST_TIMEOUT: parseInt(process.env.RPC_TEST_TIMEOUT || '10000'),
    SLOW_RPC_THRESHOLD: parseInt(process.env.SLOW_RPC_THRESHOLD || '5000')
  }
}
